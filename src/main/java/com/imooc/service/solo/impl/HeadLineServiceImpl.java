...
public class HeadLineServiceImpl implements HeadLineService {
    ...
    @Override
    public Result<Boolean> remove(int headLineId) {
        return null;
    }
    ...
    @Override
    public Result<HeadLine> get(int headLineId) {
        return null;
    }

    @Override
    public Result<List<HeadLine>> list(HeadLine headLineCondition, int pageIndex, int pageSize) {
